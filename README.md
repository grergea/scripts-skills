...
- **vault-management** - Vault status report generation for /lint (clipping alerts, link health, concept stats, raw-source concept coverage, monthly check history) — run manually via vault-report.py
